...
%préciser les comparaisons et présenter un peu les svm en même temps, comparaison des résultats à effectuer

\begin{figure}[h]\centering
\includegraphics[scale=0.6]{svmxor.png}
\caption{Reconnaissance par un svm du xor}
\label{fig:Neurone}
\end{figure}
